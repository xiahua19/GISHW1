...
namespace MyMapObjects
{
    public partial class MyMapControl : UserControl
    {
        ...
        // 在屏幕上移动BufferMap2时，先将2绘制到3上，再将3绘制到屏幕上
        // 以避免清除屏幕带来的闪烁
        ...
        public void FalshShapes(moShape[] shapes, Int32 times, Int32 interval)
        {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void MyMapControl_Paint(object sender, PaintEventArgs e)
        {
            // 将buffer2绘制到控件上
        ...
        private moUserDrawingTool CreateDrawingTool(Graphics g)
        {
            ...
            moUserDrawingTool sDrawingToll = new moUserDrawingTool(g, sExtent, sMapScale, dpm, mpu);
